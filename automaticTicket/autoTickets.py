...
from automaticTicket.send_email import sendEmail
...
class autoTickets(object):
    ...
    def get_passenger_Str(self):
        ...
        self.oldpassengerStr = ''
        self.passengerTicketStr = ''
        seat_dict = {'无座': '1', '硬座': '1', '软座': '2', '硬卧': '3', '软卧': '4', '高级软卧': '6', '动卧': 'F', '二等座': 'O',
                     '一等座': 'M', '商务座': '9', }
        ...
        for person in passengers:
            for passenger in self.passengers:
                if person != passenger['passenger_name']:
                    continue
                self.oldpassengerStr += ','.join(
                    [passenger['passenger_name'], passenger['passenger_type'], passenger['passenger_id_no'], '1_'])
                self.passengerTicketStr += ','.join(
                    [self.seat_type, '0,1', passenger['passenger_name'], passenger['passenger_type'],
...
if __name__ == "__main__":
    ...
    Ticket = autoTickets(config=config)
    Ticket.login_12306()
    while 1:
        time.sleep(1)
